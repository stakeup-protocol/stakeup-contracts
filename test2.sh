...
# TODO: Fix this to work with wake-coverage.cov
# while IFS= read -r line; do
#     if [[ $line == *"/src/"* ]]; then
#         # Get the line count
#         lines_found=${line#LF:}
...
# Delete temp files
rm lcov.info merged-lcov.info files_with_lines_coverage.txt wake-coverage.cov .coverage
