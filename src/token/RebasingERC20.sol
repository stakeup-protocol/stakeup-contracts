...
abstract contract RebasingERC20 is IRebasingERC20, ERC20Burnable, Ownable2Step {
    ...
    // =================== Constructor ===================
    constructor(string memory name_, string memory symbol_, address owner_) ERC20(name_, symbol_) Ownable2Step() {
