...
//     function add_reward(address reward_token, address distributor) external override {
//         _rewardToken = reward_token;
//         _distributor = distributor;
//     }

//     function deposit_reward_token(address reward_token, uint256 amount) external override {
...
//     function reward_tokens(uint256 index) external view override returns (address) {}
// }
