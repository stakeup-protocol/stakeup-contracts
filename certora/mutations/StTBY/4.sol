...
index 923c7d3..51af31e 100644
--- a/certora/munged/StTBYMunged.sol
+++ b/certora/munged/StTBYMunged.sol
@@ -371,7 +371,7 @@ contract StTBY is IStTBY, StTBYBase, ReentrancyGuard {
...
+            _rewardManager.distributeMintRewards(address(_stakeupStaking), eligibleAmount);
         }
