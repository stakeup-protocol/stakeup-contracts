...
index 04e70a2..b1937a3 100644
--- a/src/staking/SUPVesting.sol
+++ b/src/staking/SUPVesting.sol
@@ -61,8 +61,8 @@ abstract contract SUPVesting is ISUPVesting {
...
+        if (allocation.vestingStartTime == block.timestamp) {
+            _tokenAllocations[account].vestingStartTime = 0;
