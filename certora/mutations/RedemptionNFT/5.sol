...
index 48a2a44..84d381d 100644
--- a/src/token/RedemptionNFT.sol
+++ b/src/token/RedemptionNFT.sol
@@ -197,7 +197,7 @@ contract RedemptionNFT is IRedemptionNFT, ONFT721 {
         if (nextIndex < tokenIds.length) {
             // not enough gas to complete transfers, store to be cleared in another tx
             bytes32 hashedPayload = keccak256(_payload);
-            storedCredits[hashedPayload] = StoredCredit(_srcChainId, toAddress, nextIndex, true);
+            storedCredits[hashedPayload] = StoredCredit(_srcChainId, toAddress, tokenIds.length, true);
