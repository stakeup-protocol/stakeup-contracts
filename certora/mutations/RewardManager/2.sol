...
index 728715d..b877ccf 100644
--- a/src/rewards/RewardManager.sol
+++ b/src/rewards/RewardManager.sol
@@ -73,8 +73,8 @@ contract RewardManager is IRewardManager, CurveGaugeDistributor {
         uint256 stTBYAmount
...
+        uint256 rewardAmount = (STTBY_MINT_THREASHOLD * stTBYAmount) /
+            LAUNCH_MINT_REWARDS;
