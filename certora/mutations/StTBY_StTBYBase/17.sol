...
/**************************** Diff Block Start ****************************
diff --git a/src/token/StTBYBase.sol b/src/token/StTBYBase.sol
index 6e15e00..9214107 100644
--- a/src/token/StTBYBase.sol
+++ b/src/token/StTBYBase.sol
@@ -151,7 +151,7 @@ contract StTBYBase is IStTBYBase, OFT {
         address spender,
         uint256 addedValue
     ) public override returns (bool) {
-        _approve(msg.sender, spender, _allowances[msg.sender][spender] + addedValue);
+        _approve(msg.sender, spender, _allowances[spender][msg.sender] + addedValue);
         return true;
     }
