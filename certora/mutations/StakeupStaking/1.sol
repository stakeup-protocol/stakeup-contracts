...
index 1849631..9db6e6b 100644
--- a/src/staking/StakeupStaking.sol
+++ b/src/staking/StakeupStaking.sol
@@ -122,7 +122,7 @@ contract StakeupStaking is IStakeupStaking, SUPVesting, ReentrancyGuard {
...
+        IERC20(address(_stakeupToken)).safeTransfer(msg.sender, userStakingData.amountStaked);
