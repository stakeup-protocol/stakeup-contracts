...
index 1849631..1fd4e3b 100644
--- a/src/staking/StakeupStaking.sol
+++ b/src/staking/StakeupStaking.sol
@@ -271,7 +271,7 @@ contract StakeupStaking is IStakeupStaking, SUPVesting, ReentrancyGuard {
             rewardIndex
         );
 
-        userStakingData.index = uint128(rewardIndex);
+        userStakingData.index = uint128(rewardDelta);
