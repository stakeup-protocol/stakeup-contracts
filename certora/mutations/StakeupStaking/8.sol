...
index 1849631..0d505e8 100644
--- a/src/staking/StakeupStaking.sol
+++ b/src/staking/StakeupStaking.sol
@@ -119,7 +119,7 @@ contract StakeupStaking is IStakeupStaking, SUPVesting, ReentrancyGuard {
             }
         }
 
-        userStakingData.amountStaked -= uint128(stakeupAmount);
+        userStakingData.amountStaked -= uint128(userStakingData.rewardsAccrued);
