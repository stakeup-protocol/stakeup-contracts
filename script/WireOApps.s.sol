...
contract WireOAppsScript is Script {
    ...
    function run() public {
        ...
        BridgeOperator operator = BridgeOperator(0xb1F14EBD8188441d2527E72913b71FFcF45585b1);
        operator.setWstTBYBridge(uint32(LAYER_ZERO_EID_SEP), 0xd2FC5AA33D9825ad5664Ca6742b8e0a70029AA63);
        operator.setWstTBYBridge(uint32(LAYER_ZERO_EID_ARB_SEP), 0xca7aE3BB3389e0Ddc22d0f9bFcB7DFa8fdFEF81B);

        basePeers[0] = addressToBytes32(0x68997637aa6657295B60edF9ab8C16310B9717A5);
        basePeers[1] = addressToBytes32(0x120b677acd511A15992d7E09BC37be9dF46d8Ac6);
        basePeers[2] = addressToBytes32(0x1E41135733611eB4068fACb0e233B8d7d9d60CEB);

        sepPeers[0] = addressToBytes32(0xb4E9a3d383dC174B479b805f141595c44Dd1562D);
        sepPeers[1] = addressToBytes32(0xd2FC5AA33D9825ad5664Ca6742b8e0a70029AA63);
        sepPeers[2] = addressToBytes32(0xd06fc810D15f11f32B576e3f4F89C44aC9c3D366);

        arbPeers[0] = addressToBytes32(0xE274423b1d8d32C485cFC08FEbfD88247149b49d);
        arbPeers[1] = addressToBytes32(0xca7aE3BB3389e0Ddc22d0f9bFcB7DFa8fdFEF81B);
        arbPeers[2] = addressToBytes32(0x4C5EFa7fA20f707c3B1B1FB15a92537c0FDbc363);
