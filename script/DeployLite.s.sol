...
//         address expectedMessengerAddress = LibRLP.computeAddress(owner, vm.getNonce(owner) + 1);

//         StTBYBase stTBY = new StTBYBase(address(LAYER_ZERO_ENDPOINT_SEP), expectedBridgeOperatorAddress);
//         console2.log("stTBY", address(stTBY));

//         StakeUpTokenLite sup = new StakeUpTokenLite(address(LAYER_ZERO_ENDPOINT_SEP), expectedBridgeOperatorAddress);
...
//             new WstTBYBridge(address(wstTBY), address(LAYER_ZERO_ENDPOINT_SEP), expectedBridgeOperatorAddress);
...
//         require(address(bridgeOperator) == expectedBridgeOperatorAddress, "Incorrect bridge operator address");
//     }
// }
